...
The proposal has moved in fits, and two separate instruments are easy to confuse. One is a temporary derogation that let providers scan voluntarily; in March 2026 the European Parliament declined to extend it, by a single vote (307 to 306), and its legal basis lapsed in early April 2026. The other is the permanent CSA Regulation, the instrument that in its strongest form would mandate detection, including client-side scanning. The Council's general approach of November 2025 dropped mandatory detection orders but kept a permanent voluntary-scanning framework, age-verification duties reaching encrypted services, and risk-mitigation obligations broad enough to pressure encrypted services into changing how they work. That regulation went into trilogue, and by mid-2026 the institutions were moving to restore a temporary scanning regime after the derogation lapsed. Its final shape is not settled.
