...
In a standard greenhouse, the assets are visible: this plant, that soil, those seeds.
In this one, the assets are less tangible and more layered. Nation-state surveillance
operates across three tiers simultaneously, and what constitutes a valuable asset
changes depending on which adversary is doing the looking and what they need it for.
...
Non-governmental organisations, civil society groups, trade unions, religious
...
At the structural level, the key insight is this: the asset is not a person. It is a
