...
Browser fingerprinting is widely used in advertising, fraud detection, and analytics. Its value lies precisely in its persistence: it survives the privacy measures people commonly take. A person who clears their cookies, uses private browsing, and changes their IP address still presents the same fingerprint if they have not changed their browser, device, or configuration.

The Electronic Frontier Foundation's Panopticlick study, published in 2010, found that over 80% of browsers carried a unique fingerprint among its test population. Its successor, Cover Your Tracks, and the independent Amiunique.org both let anyone check their own browser against a current distribution.
