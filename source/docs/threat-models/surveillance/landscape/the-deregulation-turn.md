...
On 19 November 2025 the European Commission published the [Digital Omnibus](https://edri.org/our-work/reopening-gdpr-and-eprivacy-through-the-digital-omnibus-a-risky-path-for-eu-digital-rights/), a package presented as a "simplification" of the digital rulebook. Digital-rights groups read it differently, as the largest rollback of data-protection rights in EU history, moved quickly and with limited scrutiny. Three changes bear directly on surveillance and profiling.
...
A legitimate-interest basis would be [opened for training AI systems](https://noyb.eu/en/digital-omnibus-report-v3-analysis-select-gdpr-and-eprivacy-proposals-commission) on personal data, letting firms use posts, photos and other material to train models without meaningful consent, and without a clear route to opt out or to have the data removed once used.
